...
{
    /// <inheritdoc />
    public partial class AddUserIsLockedAndMonthlyPassStatus : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstBlockPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    FirstBlockHours = table.Column<int>(type: "int", nullable: false),
                    OvernightPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    MaxHeight = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportedStatus = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CrowdsourceReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CrowdsourceReports_ParkingLots_ParkingLotId",
                        column: x => x.ParkingLotId,
                        principalTable: "ParkingLots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CrowdsourceReports_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavouriteParkingLots", x => new { x.UserId, x.ParkingLotId });
                    table.ForeignKey(
                        name: "FK_FavouriteParkingLots_ParkingLots_ParkingLotId",
                        column: x => x.ParkingLotId,
                        principalTable: "ParkingLots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FavouriteParkingLots_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomBackgroundImageUrl = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingFloors_LayoutTemplates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "LayoutTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ParkingFloors_ParkingLots_ParkingLotId",
                        column: x => x.ParkingLotId,
                        principalTable: "ParkingLots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParkingLotStaffs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ParkingLotStaffs_ParkingLots_ParkingLotId",
                        column: x => x.ParkingLotId,
                        principalTable: "ParkingLots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ParkingLotStaffs_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MonthlyPasses_ParkingLots_ParkingLotId",
                        column: x => x.ParkingLotId,
                        principalTable: "ParkingLots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ParkingFloorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingSlots_ParkingFloors_ParkingFloorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuestLicensePlate = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ParkingLotId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CrowdsourceReports_ParkingLotId",
                table: "CrowdsourceReports",
                column: "ParkingLotId");

            migrationBuilder.CreateIndex(
                name: "IX_CrowdsourceReports_UserId",
                table: "CrowdsourceReports",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_FavouriteParkingLots_ParkingLotId",
                table: "FavouriteParkingLots",
                column: "ParkingLotId");

            migrationBuilder.CreateIndex(
                name: "IX_MonthlyPasses_ParkingLotId",
                table: "MonthlyPasses",
                column: "ParkingLotId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingFloors_ParkingLotId",
                table: "ParkingFloors",
                column: "ParkingLotId");

            migrationBuilder.CreateIndex(
                name: "IX_ParkingFloors_TemplateId",
                table: "ParkingFloors",
                column: "TemplateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingLotStaffs_ParkingLotId",
                table: "ParkingLotStaffs",
                column: "ParkingLotId");

            migrationBuilder.CreateIndex(
                name: "IX_ParkingLotStaffs_UserId",
                table: "ParkingLotStaffs",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ParkingSlots_ParkingFloorId",
                table: "ParkingSlots",
